...
public class FileMain {
	...
	public static void main(String[] args) throws Exception{
		/*
		 * 현재경로[기준경로]
		 * C:\2022-05-JAVA-DEVELOPER\eclipse-workspaceSE\21.입출력[IO]
		 * 
		 * 상대(relative)경로
		 * 	현재 경로를 기준으로 경로를 기술
		 * 절대(absolute)경로
		...
		System.out.println("--------1. file path[relativce](상대 경로)-----------");
		System.out.println(file1.getPath());
		System.out.println(file2.getPath());
		System.out.println(file3.getPath());
		System.out.println(file4.getPath());
		
		System.out.println("--------2. file absolute path[absolute](절대 경로)-----------");
		...
		System.out.println("newDir1의 존재 여부 : "+newDir1.exists());
		System.out.println("newDir2의 존재 여부 : "+newDir2.exists());
		System.out.println("newDir3의 존재 여부 : "+newDir3.exists());
		...
		System.out.println("newFile1 생성 여부 : "+ newFile1.createNewFile());
		System.out.println("newFile2 생성 여부 : "+ newFile2.createNewFile());
		System.out.println("newFile3 생성 여부 : "+ newFile3.createNewFile());
		
		System.out.println("newFile1 삭제 여부 : "+ newFile1.delete());
